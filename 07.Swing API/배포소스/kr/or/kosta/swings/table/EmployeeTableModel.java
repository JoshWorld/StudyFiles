...
public class EmployeeTableModel extends AbstractTableModel {
	...
	public EmployeeTableModel(){
		...
		// 테스트를 위한 사원데이터
		Employee emp1 = new Employee("김기정", "1234", "KOSTA", 40, 53.56, true, new ImageIcon("classes/images/add.gif"));
		Employee emp2 = new Employee("박기순", "1234", "KOSTA", 40, 53.56, false, new ImageIcon("classes/images/add_index.gif"));
